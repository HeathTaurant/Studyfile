...
<html>
  <head>
    ...
    <link rel="stylesheet" href="../../css/Survey/question_style.css" />
    <script src="../../js/Survey/question_script.js" defer></script>
  ...
  <body>
    <form class="container" action="test.html" method="get">
      ...
      <div class="question__box">
        <!-- 단맛 -->
        <div class="box sweet">
          <img class="list__img" src="../../image/Survey/img/question/taste_sweet.png" alt="" />
        ...
        <!-- 신맛 -->
        <div class="box sour">
          <img class="list__img" src="../../image/Survey/img/question/taste_sour.png" alt="" />
        ...
        <div class="box refresh">
          <img class="list__img" src="../../image/Survey/img/question/taste_refresh.png" alt="" />
        ...
        <!-- 바디감 -->
        <div class="box body">
          <img class="list__img" src="../../image/Survey/img/question/taste_body.png" alt="" />
        ...
        <!-- 향 -->
        <div class="box scent">
          <img class="list__img" src="../../image/Survey/Survey/img/question/taste_scent.png" alt="" />
        ...
        <!-- 알콜도수 -->
        <div class="box alc">
          <img class="list__img" src="../../image/Survey/img/question/taste_alc.png" alt="" />
